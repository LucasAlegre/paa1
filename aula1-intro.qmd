...
institute: |
  ...
  <br><br><br>
  <span style="font-size: 0.55em;">Estes slides utilizam conteúdo adaptado da bibliografia da disciplina e também de notas de aula e slides prévios dos professores Bruno Grisci, Rodrigo Machado, André Grahl Pereira, Lucas Nunes Alegre, Marcus Ritt e Luciana Buriol.</span>
date: ""
lang: pt-BR
...
:::
::: {.column width="38%"}
![Book 1](./images/book1.PNG){width=30%}

![Book 2](./images/book2.PNG){width=30%}

![Book 3](./images/book3.jpg){width=30%}
:::
::::
...
![LPC](../images/Captura%20de%20tela%20de%202026-02-17%2014-37-44.png){width=75%}
...
![Moedas](../images/US-Coin-Denomination_6778-0049_a_main.jpg){width=45%}
...
```text
CASHIERS-ALGORITHM(x, c1, ..., cn)
1. Ordene as moedas: 0 < c1 < c2 < ... < cn
2. S <- []
3. enquanto x > 0:
4.   k <- maior índice tal que ck <= x
5.   se não existe tal k:
6.      retorne "sem solução"
7.   senão:
8.      x <- x - ck
9.      adicione k ao final de S
10. retorne S
```
...
![Stamps](../images/stamps.png){width=50%}
...
[**Teorema.**]{.bold-emph} O algoritmo do caixa é ótimo para $\{1,5,10,25,100\}$.
