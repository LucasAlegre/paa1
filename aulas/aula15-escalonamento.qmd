...
> [**Objetivo.**]{.label-def} Encontrar o subconjunto máximo de tarefas compatíveis.
...
![](images/g1.png){width=50% fig-align="center"}


## {data-background-iframe="https://brunogrisci.github.io/schedulingalgorithms" data-background-interactive="true" .hide-header}
...
![](images/intervals-example.png){width=70% fig-align="center"}
...
\begin{algorithmic}
\Procedure{TerminaMaisCedo}{$\{s_1, f_1\}, \dots, \{s_n, f_n\}$}
  \State \texttt{Sort}$(\{s_1, f_1\}, \dots, \{s_n, f_n\})$ \Comment{Em ordem crescente de $f_j$}
...
> [**Definição (Particionamento de Intervalos).**]{.label-def}
>
...
![](images/g6.png){width=50% fig-align="center"}
...
![](images/g4.png){width=50% fig-align="center"}
...
\begin{algorithmic}
\Procedure{IniciaMaisCedo}{$\{s_1, f_1\}, \dots, \{s_n, f_n\}$}
  \State \texttt{Sort}$(\{s_1, f_1\}, \dots, \{s_n, f_n\})$ \Comment{Em ordem crescente de $s_j$}
...
## Algoritmos de Escalonamento e Particionamento de Intervalos
