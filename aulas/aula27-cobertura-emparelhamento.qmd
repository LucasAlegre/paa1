...
- *CMV* é um problema conhecidamente [NP-difícil]{.alert}, para o qual habitualmente são utilizadas heurísticas.
...
> Contudo, conjecturamos que a resposta seja [não]{.alert}!
...
- Um problema é **NP-completo** quando:
  ...
  - está em **NP**;
  - é [tão difícil quanto]{.alert} qualquer outro problema em **NP**.
