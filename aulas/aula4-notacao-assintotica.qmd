...
> [**Prova.**]{.label-prf} Escolha $\textcolor{#2e7d32}{n_0}=1$ e $\textcolor{red}{c}=|a_k|+\dots+|a_1|+|a_0|$.

. . .

Nós temos que mostrar que $\forall n \geq \textcolor{#2e7d32}{n_0}, T(n) \leq \textcolor{red}{c} \cdot n^k$.
...
$T(n) \leq \textcolor{red}{c} \cdot n^k$ $\blacksquare$
