...
Além dos exercícios abaixo, também é sugerido realizar os exercícios adicionais do Prof. Frederico Messa: [Lista 1 (PDF)](lista1-frederico.pdf).
...
6. Para cada um dos itens abaixo, use a ferramenta GeoGebra para encontrar valores de $c$ e $n_0$: [https://www.geogebra.org/classic/vbuhdgxu](https://www.geogebra.org/classic/vbuhdgxu)

   a) $(n+1)^5 = O(n^5)$
   b) $2^{(n-1)} = \Omega(2^n)$
   c) $7n^2 = \Omega(n \log n)$
   d) $12n^2 + 6n + 4 = \Theta(n^2)$
